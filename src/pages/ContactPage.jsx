      ...
      <div className="Contact-global ">
        <article className="Contact-article wrapper">
          <div className="Contact-info">
            <h2 className="Contact-h2 animate__animated animate__backInLeft">
              ponte en contacto
            </h2>
            <h3 className="Contact-h3 animate__animated animate__backInLeft">
              contacto
            </h3>
            <span className="Contact-span animate__animated animate__backInLeft">
          ...
          <form action="#" className="Contact-form" onSubmit={handleSubmit}>
            {contact.map((ele) => (
              <div key={ele.id} className="Contact-formcontainer">
                <input
                  type={ele.input}
                  className="Contact-input animate__animated animate__backInLeft"
                  name={ele.name}
                  pattern={ele.patern}
            ...
            <textarea
              ...
              rows="2"
              placeholder="Mensaje"
              className="Contact-input Contact-input--textarea animate__animated animate__backInLeft"
              onChange={handleChange}
              onBlur={handleBlur}
              value={form.mensaje}
              required
            ...
            {errors.mensaje && (
              <div className="Contact-container">
                ...
                <p className="Contact-error">{errors.mensaje}</p>
              </div>
            )}
            <button
              type="submit"
              className="Contact-button animate__animated animate__backInLeft"
            >
              Enviar
            </button>
          </form>
            ...
            <div className="Contact-div Contact-div--icons">
              <div className="Contact-card">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fillRule="currentColor"
                  className="Contact-icon animate__animated animate__backInLeft"
                  viewBox="0 0 16 16"
                >
                ...
                <a
                  ...
                  className="Contact-a animate__animated animate__backInLeft"
                >
              ...
              <div className="Contact-card">
                ...
                <a
                  href="tel:+34%20633%2061%2088%2077%20"
                  className="Contact-a animate__animated animate__backInLeft"
                >
                  +34 633 61 88 77
                </a>
